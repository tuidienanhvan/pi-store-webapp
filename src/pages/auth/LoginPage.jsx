...
function PiOrbitMap() {
  return (
    <svg className="auth-orbit" viewBox="0 0 520 520" role="img" aria-label="Bản đồ vận hành Pi Ecosystem">
      ...
      <circle className="auth-orbit__node auth-orbit__node--sat" cx="260" cy="50" r="12" style={{ animationDelay: '-1s' }} />
      <circle className="auth-orbit__node auth-orbit__node--sat" cx="470" cy="260" r="10" style={{ animationDelay: '-3s' }} />

      {/* Middle Ring (Tilted) */}
      <ellipse className="auth-orbit__ring auth-orbit__ring--tilt" cx="260" cy="260" rx="200" ry="120" />
      <circle className="auth-orbit__node auth-orbit__node--sat" cx="460" cy="260" r="14" style={{ animationDelay: '-2s' }} />
      <circle className="auth-orbit__node auth-orbit__node--sat" cx="60" cy="260" r="8" style={{ animationDelay: '-5s' }} />

      {/* Inner Ring */}
      <circle className="auth-orbit__ring auth-orbit__ring--inner" cx="260" cy="260" r="140" />
      <circle className="auth-orbit__node auth-orbit__node--sat" cx="260" cy="120" r="10" style={{ animationDelay: '-4s' }} />
      <circle className="auth-orbit__node auth-orbit__node--sat" cx="120" cy="260" r="12" style={{ animationDelay: '-1.5s' }} />
      ...
      <section className="auth-split__marketing" aria-label="Pi Ecosystem">
        <div className="marketing-content">
          ...
          <h2 className="marketing-title">
            Vận hành site như một <span>trung tâm điều khiển.</span>
          </h2>
