  ...
  return (
    ...
    <div className="stack gap-8">
      ...
      <header className="stack gap-2">
        ...
        <p className="m-0 text-lg muted">Manage your license key and activation stats.</p>
      ...
      {stats ? (
        ...
        <>
          ...
          <Card className="p-0 overflow-hidden">
            ...
            <div className="grid grid-cols-3" style={{ background: "var(--base-300)", gap: 1 }}>
          ...
          <Card className="stack gap-4 p-5">
            ...
            <h2 className="m-0 text-2xl">License key</h2>

            {licenseKey ? (

              <div className="row justify-between items-center p-4 rounded-md border border-hairline bg-base-200-2">

                <code className="text-lg font-semibold text-primary">{licenseKey}</code>
