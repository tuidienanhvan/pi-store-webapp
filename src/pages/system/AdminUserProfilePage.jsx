...
import { Card, Button, Input, Icon, Badge, IconButton, Alert } from "@/components/ui";
...
export function AdminUserProfilePage() {
  ...
  if (!user) return (
    <div className="p-10 text-center">
      <Icon name="user-x" size={48} className="mx-auto opacity-20 mb-4" />
      ...
      <header className="profile-header stagger-1">
        <div className="flex items-center gap-4">
          <Link to="/admin/users" className="group">
            <IconButton icon="arrow-left" label="Quay li" variant="ghost" className="group-hover:-translate-x-1 transition-transform" />
          </Link>
