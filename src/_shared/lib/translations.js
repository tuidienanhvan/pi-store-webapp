...
export const ADMIN_T = {
  vi: {
    ...
    tokens_used: "Token đã dùng",
    system_status: "Trạng thái hệ thống",
    provider_health_matrix: "Sức khỏe nhà cung cấp",
    key_pool_status: "Trạng thái kho khóa",
    realtime_alerts: "Cảnh báo tức thời",
  ...
  en: {
    ...
    provider_health_matrix: "Provider Health",
...
export function formatRelative(iso, _locale = "vi") {
  return iso ? "just now" : "?";
}
