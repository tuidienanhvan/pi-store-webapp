...
import { Avatar, Icon, IconButton, ThemeToggle } from "../ui";
...
// NavLink class helper  Tailwind-driven active/hover states
      ...
      <nav className="dash__nav">
        ...
        {nav.map((groupObj) => {
          ...
          if (!groupObj.group) {
            ...
            return (
              ...
              <NavLink key={item.to} to={item.to} end={item.end}
                ...
                {item.icon === "logo-optimized" ? <PiLogo size={16} /> : <Icon name={item.icon || "circle"} size={16} />}
          ...
          return (
            ...
            <div key={groupObj.group} className="flex flex-col gap-1 mt-4 first:mt-0">
