...
export function SiteFooter() {
  ...
  return (
    <footer className="site-footer site-footer--shell bg-surface-1 border-t border-hairline">
      <div className="container stack gap-12">
        <div className="grid --cols-4 gap-12 items-start">
          <div className="stack gap-5">
            ...
            <p className="m-0 text-14 muted opacity-70 leading-relaxed max-w-[280px] font-medium">{t.tagline}</p>
          ...
          <div className="flex justify-between items-center flex-wrap gap-y-4 text-13 muted font-medium">
            <div className="row gap-4 items-center">
              ...
              <span className="row gap-1">
                Made with <Heart size={12} className="text-brand" fill="currentColor" /> in Vietnam
              </span>
            </div>
            <div className="row gap-4 items-center opacity-80">
              <span className="text-2">v1.0 Beta · Early access launch</span>
              <span className="opacity-20">|</span>
