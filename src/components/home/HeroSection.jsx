    ...
    <section className="container py-16">
      ...
      <div className="grid grid-cols-2 gap-12 items-center">
        ...
        <div className="stack gap-6">
          ...
          <Badge tone="brand" className="text-sm w-fit px-3 py-1">

            {dict.hero.saleBadge}

          </Badge>

          <p className="text-sm muted uppercase tracking-wide m-0 font-semibold">

            {dict.hero.eyebrow}

          </p>

          <h1 className="text-5xl leading-tight m-0">
        ...
        <div>
          ...
          {featured ? (
            ...
            <Card className="overflow-hidden bg-base-200-2 p-0" style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div className="stack gap-3 p-5 bg-base-200">
                ...
                <div className="row justify-between mt-2">
                  ...
                  <div className="row items-baseline gap-2">
                    ...
                    <strong className="text-xl">{featured.localizedPricing.label}</strong>

                    <span className="text-sm muted">{featured.localizedPricing.billing}</span>
