  ...
  return (
      <AdminCard className={`w-full max-w-lg p-12 border-dashed ${className}`}>
        <div className="flex flex-col items-center text-center">
          <div className="w-20 h-20 rounded-full bg-base-content/5 flex items-center justify-center mb-6">
            <Icon size={40} className="text-base-content/20" />
          </div>
          <h3 className="text-lg font-semibold text-base-content tracking-wider mb-2">{title}</h3>
