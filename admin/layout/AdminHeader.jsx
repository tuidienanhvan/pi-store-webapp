...
export function AdminHeader({ title, onMenuClick }) {
  return (
    <header className="h-14 border-b border-base-content/5 sticky top-0 z-30 backdrop-blur-xl bg-base-100/60">
      <div className="mx-auto w-full max-w-[1600px] px-6 lg:px-10 h-full flex items-center justify-between">
        <div className="flex items-center gap-3">
          <IconButton
            icon={Menu}
            label="Menu"
            className="lg:hidden text-base-content/70 hover:bg-base-content/5 transition-colors"
            onClick={onMenuClick}
          />
