        ...
        actions={
          <div className="flex items-center gap-2 bg-white/[0.03] p-1 rounded-xl border border-white/5">
            {DAYS_OPTIONS.map((d) => (
              <button key={d} 
                onClick={() => setDays(d)}
                className={`h-8 px-4 rounded-lg text-[9px] font-bold uppercase tracking-widest transition-all duration-300 ${days === d ?"bg-primary text-white" : "text-base-content/40 hover:text-base-content/60 hover:bg-white/5"}`}>
                {d === 365 ? "Năm" : `${d} Ngày`}
              </button>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <AdminCard className="p-8">
              <div className="flex items-center gap-3 mb-8">
                 ...
                 <h2 className="text-[10px] font-bold uppercase tracking-widest text-base-content/40">Phân bổ danh mục</h2>
              </div>
                ...
                <div className="relative w-56 h-56 shrink-0">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-[70%] h-[70%] bg-base-300 rounded-full flex flex-col items-center justify-center border border-white/5 shadow-inner">
                      <span className="text-[8px] font-bold text-base-content/30 uppercase tracking-widest mb-1">Tổng cộng</span>
                    ...
                    <div key={item.sku} className="group flex items-center justify-between p-3 rounded-xl hover:bg-white/[0.03] transition-all">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                           ...
                           <span className="text-[8px] font-bold text-base-content/20 uppercase tracking-widest">{item.sku}</span>
                        </div>
                      </div>
            ...
            <section className="flex flex-col gap-4">
               <div className="flex items-center gap-3 px-2">
                  ...
                  <h2 className="text-[10px] font-bold uppercase tracking-widest text-base-content/40">Nhật ký doanh thu sản phẩm</h2>
               </div>

               <AdminTable>
                 <thead>
                    <tr className="bg-white/[0.02]">
                       <th className="py-4 px-6 text-left font-bold uppercase tracking-widest text-[9px] opacity-40">Sản phẩm / Mã</th>
                       <th className="py-4 px-6 text-center font-bold uppercase tracking-widest text-[9px] opacity-40">Phân loại</th>
                       <th className="py-4 px-6 text-right font-bold uppercase tracking-widest text-[9px] opacity-40">Số lượng</th>
                    ...
                    {products.map((item) => (
                      <tr key={item.sku} className="group hover:bg-white/[0.01] transition-colors">
                        <td className="py-5 px-6">
                           <div className="flex flex-col">
                              <span className="text-xs font-bold text-base-content group-hover:text-primary transition-colors">{item.name}</span>
                              <span className="text-[9px] font-mono font-bold text-base-content/20 uppercase tracking-tighter">{item.sku}</span>
                           </div>
                        </td>
                        <td className="py-5 px-6 text-center">
                           <AdminBadge tone="neutral">{item.type.toUpperCase()}</AdminBadge>
                        </td>
                        ...
                        <td className="py-5 px-6 text-right">
                           <div className="flex flex-col items-end">
                              ...
                              <span className="text-[8px] font-bold text-white/10 uppercase tracking-widest">Doanh thu gộp</span>
                           </div>
                        </td>
                      </tr>
                    ))}
