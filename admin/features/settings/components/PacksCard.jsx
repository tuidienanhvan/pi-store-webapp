  ...
  return (
    <section className="flex flex-col gap-6">
      ...
      <AdminTable>
        <thead>
          <tr className="bg-base-content/[0.02]">
            ...
            <th className="py-4 px-6 text-right font-semibold tracking-wider text-xs opacity-40">Giá (Cents)</th>
            <th className="py-4 px-6 text-right font-semibold tracking-wider text-xs opacity-40">Giảm giá %</th>
      ...
      <div className="flex justify-end">
        <Button type="button" variant="primary" disabled={saving} onClick={() => onSave(rows)} className="h-11 px-10 rounded-xl font-semibold tracking-wider text-xs">
