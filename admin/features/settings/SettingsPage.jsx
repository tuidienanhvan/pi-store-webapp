  ...
  if (!settings) return (
    <div className="p-20 flex flex-col items-center">
       <AdminCard className="p-12 text-center max-w-md">
          ...
          <Button onClick={load} variant="primary" className="h-12 px-8 rounded-xl font-bold uppercase text-[10px] tracking-widest">
      ...
      <div className="flex flex-col gap-16">
        ...
        <section className="flex flex-col gap-6">
          <div className="flex items-center gap-3 px-2">
             ...
             <h2 className="text-[10px] font-bold uppercase tracking-widest text-base-content/40">Thông số bảo mật (Chỉ đọc)</h2>
          </div>
                   ...
                   { label: 'Thời hạn JWT', val: 'JWT_EXPIRE_MINUTES', icon: Clock },
                    ...
                    <div key={item.val} className="flex items-center justify-between p-4 rounded-xl bg-white/[0.02] border border-white/5">
                       <div className="flex items-center gap-3">
                          ...
                          <span className="text-[11px] font-bold uppercase text-base-content/60 tracking-wider">{item.label}</span>
                       </div>
